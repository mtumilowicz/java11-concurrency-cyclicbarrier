[![Build Status](https://travis-ci.com/mtumilowicz/java11-concurrency-cyclicbarrier.svg?branch=master)](https://travis-ci.com/mtumilowicz/java11-concurrency-cyclicbarrier)
